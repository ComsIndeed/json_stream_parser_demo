...
class _UiGenerationDemoPageState extends State<UiGenerationDemoPage> {
  ...
  Widget _buildPreviewPanel(BuildContext context, Size sizes, bool isMobile) {
    return Consumer<WidgetStreamHandler>(
      builder: (context, handler, _) {
        return Card(
          color: Theme.of(context).colorScheme.surfaceContainer,
          shape: RoundedSuperellipseBorder(
            borderRadius: BorderRadius.circular(isMobile ? 24 : 64),
            side: BorderSide(
              color: Theme.of(context).colorScheme.primary,
              width: 1,
            ),
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: _buildPreviewPanel(context, sizes, isMobile),
                        ),
