...
class HeroDemoItem extends StatefulWidget {
  ...
  @override
  State<HeroDemoItem> createState() => _HeroDemoItemState();
}

class _HeroDemoItemState extends State<HeroDemoItem> {
  ...
  String get _title => 'LLM JSON Stream Demo';
  ...
  String get _json => '''{
    "title": "LLM JSON Stream Parser is Great!",
    "author": "TrulyComs2023@gmail.com", 
    "content": "I can now stream and display fields in LLM-streamed JSON data in real-time!",
    "features": [
        "Property Streaming",
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child:
                    _parser != null ? _buildOutput() : const SizedBox.shrink(),
              ),
            ],
          ),
        ],
